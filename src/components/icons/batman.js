...
const IconBatman = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="480px" height="480px">
    <path fill="#263238" d="M35.4 41L34 27 14 27 12.6 41 6 47 42 47z" />
    <path
      fill="#455a64"
    ...
    />
    <path fill="#607d8b" d="M24,33v-7.3L22,25l-1.7,6.9C21.7,32.5,23.2,33,24,33z" />
    <path
      fill="#37474f"
    ...
    />
    <path fill="#fff" d="M26 25l7-2c0 0-2 3-4 3S26 25 26 25zM22 25l-7-2c0 0 2 3 4 3S22 25 22 25z" />
    <path fill="#455a64" d="M12 17c0-7 2-16 2-16l3 9-4 7H12zM36 17c0-7-2-16-2-16l-3 9 4 7H36z" />
    <path
      fill="#607d8b"
